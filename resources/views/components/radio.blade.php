...
{{-- A themed radio, same approach as the checkbox: `appearance-none` strips the un-stylable
     native control and we draw a ring that turns primary with a filled dot when selected. Input
     and dot share one grid cell (place-items-center), so the dot is dead-centre; the dot is a
     sibling of the input so `peer-checked` can reveal it. --}}
